              ...
              @if ($message = Session::get('sukses'))
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            Mesin Injection Molding PT Shuanying International Indonesia
                        </h3>
                            ...
                            <tbody id="myTable">
                              ...
                              @else
                                ...
                                <tr>
                                  ...
                                  <td>{{$row->tahun}}</td>
                                  <td>
                                    <a href="" class="btn btn-success btn-sm" data-toggle="modal" data-target="#ModalEditMesin_{{ $row->id_mesin }}">Edit</a>
                                    <a href="" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#DeleteModal_{{$row->id_mesin}}">Delete</a>
                                  </td>
                                </tr>
                                @include('mesin.edit_mesin')
                                @include('mesin.delete_mesin')
                                @endforeach
                              @endif
                            </tbody>
                          </table>
