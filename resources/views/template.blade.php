...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('AdminLTE3/dist/img/AdminLTELogo.png')}}" alt="AdminLTELogo" height="60" width="60">
  </div> --}}
  ...
  <aside class="main-sidebar elevation-4" style="background-color: #ffffff;">
    <!-- Brand Logo -->
    <a href="/index" class="brand-link" style="background-color: #ffffff;">
      {{-- <img src="{{asset('img/LOGO_SHUANGYING.png')}}" alt="AdminLTE Logo" class="brand-image" style="opacity: .8"> --}}
      {{-- <span class="brand-text font-weight-light">-</span> --}}
      <h4 class="center" style="color: black; padding-left:50px;">SIEMIM <strong>SY</strong></h4>
    </a>
    ...
    <div class="sidebar">
      ...
      <!-- Sidebar Menu -->
      <nav class="mt-2" style="background-color: #ffffff">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="pages/calendar.html" class="nav-link">
              <img src="{{asset('img/LOGO_SHUANGYING.png')}}" alt="AdminLTE Logo" class="brand-image center" style="width:150px">
            </a>
          </li>
          ...
          <li class="nav-header">DEPARTEMEN MEE</li>
          <li class="nav-item">
            <a href="{{route('master.index_user')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route('oee.index')}}" class="nav-link">
