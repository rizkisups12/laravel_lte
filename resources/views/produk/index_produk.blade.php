              ...
              @if ($message = Session::get('sukses'))
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            Produk Injection PT Shuanying International Indonesia
                        </h3>
                            ...
                            <tbody id="myTable">
                              ...
                              @else
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <a href="" class="btn btn-success btn-sm" data-toggle="modal" data-target="#ModalEditproduk_{{$row->id_produk}}">Edit</a>
                                    <a href="" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#DeleteModal_{{$row->id_produk}}">Delete</a>
                                  </td>
                                </tr>
                                @include('produk.edit_produk')
                                @include('produk.delete_produk')
                                @endforeach
                              @endif
                            </tbody>
                          </table>
